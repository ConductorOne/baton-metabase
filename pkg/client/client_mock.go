...
type MockService struct {
	...
	RemoveUserFromGroupFunc    func(ctx context.Context, membershipID int) (*v2.RateLimitDescription, error)
}
...
func (m *MockService) RemoveUserFromGroup(ctx context.Context, membershipID int) (*v2.RateLimitDescription, error) {
